...
/**
 * SUB-COMPONENT: ProfileRegistry
 * Detailed view of the public.profiles table
 */
function ProfileRegistry({ users, loading }) {
  return (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y-2 divide-black">
              {loading ? (
                <tr>
                  <td colSpan="5" className="p-12 text-center font-mono animate-pulse uppercase opacity-50">
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F1] text-[#1A1A1A] p-4 md:p-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <ProfileRegistry users={users} loading={loading} />
