-- Keep video-call RPCs and the chat cards in sync.
-- The original guard only knew about the first-generation requested/scheduled
-- events, so newer owner invite/proposal RPCs rolled back with a 400 error.
