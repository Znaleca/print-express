...
-- Pickup orders continue to finish at COMPLETED. Delivery orders finish
-- at DELIVERY_COMPLETED so feedback is available only after delivery.
-- ============================================================
...
-- Keep the public review feed aligned with both completion states.
alter table public.orders
